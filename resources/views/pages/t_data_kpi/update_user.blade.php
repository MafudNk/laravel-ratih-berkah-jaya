...
<div class="content">
  ...
  <div class="block block-rounded">
    ...
    <div class="block-content block-content-full">
      ...
      <form class="js-validation" action="{{ route('data_kpis.save_update_isi_kpi_user', $data_kpi_id->transaksi_kpi_id) }}" method="POST">
        @csrf
        @method('patch')
        <div class="block block-rounded">
              ...
              <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$dt->skor}}</td>
                    <td> <textarea name="komentar_user_{{$key}}" id="" cols="10" rows="3">{{$dt->komentar_user}}</textarea> </td>
                    <td> {{$dt->komentar_user_penilai}}</td>
                    @endforeach
                  </tr>
                </tbody>
              </table>
